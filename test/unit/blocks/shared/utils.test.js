...
describe('aemAdmin', () => {
  ...
  it('Constructs correct AEM admin URL from path', async () => {
    ...
    expect(capturedUrl).to.equal('https://admin.eumseds.page/preview/owner/repo/main/folder/page');
  });
...
describe('getSidekickConfig', () => {
  it('Returns preview and prod when both hosts are available', async () => {
    const org = 'org1';
    const site = 'site1';
    const configUrl = `https://admin.eumseds.page/sidekick/${org}/${site}/main/config.json`;
