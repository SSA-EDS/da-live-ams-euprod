  ...
  return [
    (nxBase, location) => {
      ...
      nx = (() => {
        ...
        const isProd = !(hostname.includes('.aem.') || hostname.includes('.eumseds.') || hostname.includes('local'));
        ...
        return `https://${branch}--da-nx-ams-1128-west--ssa-eds.eumseds.live${nxVerBase}`;
      })();
      return nx;
    }, () => nx,
  ];
